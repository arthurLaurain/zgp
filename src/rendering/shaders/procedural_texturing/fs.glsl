...
void main() {
  ...
  vec2 u1 = getTexCoordFromVertexPlane(frag_position, p1, n1) * (u_scale_tex_coords + field);
  vec2 u2 = getTexCoordFromVertexPlane(frag_position, p2, n2) * (u_scale_tex_coords + field);
  vec2 u3 = getTexCoordFromVertexPlane(frag_position, p3, n3) * (u_scale_tex_coords + field);
